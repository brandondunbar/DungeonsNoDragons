...
class Spell {
    ...
    public:
        ...
        Spell(std::string _name, std::string _element, std::string _status_effect, int _damage, int _manacost);
...
Spell::Spell (std::string _name, std::string _element, std::string _status_effect, int _damage, int _manacost) {
